...
**Concrete DGM rules.** (The mode framework — expected-value vs. draw, and the scale dimension — is §14.14 of `guidance.md`; the concrete DGM shown here is the expected-value mode, and the residuals line is the draw mode's randomness kept on the page.)
