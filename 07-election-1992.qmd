...
#| echo: false
#| code-fold: false    
# DK: Is the code_fold invocation necessary?
library(gt)
```
...
1) What was the relationship between sex and voting in the 1992 US Presidential election among supporters of the three leading candidates: Clinton, Bush and Perot?*
...
<!-- IS: having trouble thinking of unconfoundedness scenario -->
...
<!-- IS: what to include in this section? check_predictions() -->
