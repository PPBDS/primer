...
<!-- AR: On the first pass, this is a lot and is confusing. I know there's this connects to the Cardinal Virtues section but I'm not sure it adds much here. Maybe connect just the virtues associated with sampling?  -->
...
```
<!-- AR: Why use the standard error versus standard deviation? -->
...
<!-- AR: combine with standard error section above? This seems to repeat information. I'm still wondering why I would use std error vs deviation. Maybe connect it more to the normal distribution? -->
