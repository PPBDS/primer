...
`inst/tutorials/<NN-name>/tutorial.Rmd` files in this package. Start at
the repo index
[`../CLAUDE.md`](https://ppbds.github.io/primer/CLAUDE.md) for the
curriculum, the base-guide relationship, and the collaboration protocol.
...
- [`../guide/authoring.md`](https://ppbds.github.io/primer/guide/authoring.md)
  — Primer tutorial structure, question flow, exercise types, child
  documents, R tooling.
- [`../guide/exercise-list.md`](https://ppbds.github.io/primer/guide/exercise-list.md)
  — the master exercise list (the per-virtue exercise sequence).
- [`../guide/per-problem/<id>.md`](https://ppbds.github.io/primer/guide/per-problem/)
  — the seed spec for the problem you’re building (read only that one).
- Shared with chapters:
  [`../guide/curriculum.md`](https://ppbds.github.io/primer/guide/curriculum.md)
  (tier and framing),
  [`../guide/tables.md`](https://ppbds.github.io/primer/guide/tables.md),
  [`../guide/concepts-and-drops.md`](https://ppbds.github.io/primer/guide/concepts-and-drops.md),
  [`../guide/guidance.md`](https://ppbds.github.io/primer/guide/guidance.md).

The tutorial directory, YAML `id`, packaged tibble (where applicable),
and student repo all share one string per tutorial
(e.g. `08-seguro-popular`); see `../guide/authoring.md` §3.
