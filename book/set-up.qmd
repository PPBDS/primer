...
This document is for **collaborators** editing the book or the **[primer.tutorials](https://ppbds.github.io/primer/tutorials/)** R package. Students consuming the curriculum should follow the [Getting Started](getting-started.html) chapter instead. You can work either on your local machine or in a [GitHub Codespace](https://github.com/features/codespaces); the steps below describe the local path, and the Codespace equivalent is noted where it differs.
