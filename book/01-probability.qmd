...
<!-- AR: I don't understand how we get this posterior distribution from this scenario. -->
...
# 226 is electoral votes for Democrats in 2024 presidential election.
...
<!-- AR: Does this description matche the code above? -->
...
<!-- AR: Wouldn't a table be a better depiction -->
...
Question : *10 people walk up to testing center, 5 of them test negative, 5 of them test positive, what is the probability that at least 6 people are actually healthy? *
...
<!-- AR: Answer the question with a calculation, not just a view of the posterior. -->
...
### Step 4: Plot the normalized posterior distribution
...
There are two main ways you could go about solving this problem with simulations.

<!-- AR: Starting with the wrong way was confusing to me. -->
