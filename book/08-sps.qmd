...
linear_reg() |>
  ...
  kable(caption = "Candidate model: t2_health_exp_3m ~ treatment. Source: King et al. (2009) SPS rollout, full follow-up sample via primer.data.")
```
...
ggplot(fitted_df, aes(x = value, fill = source)) +
  ...
  labs(
    ...
    y        = NULL,
    fill     = "Source",
    caption  = "Source: King et al. (2009) SPS rollout, full follow-up sample via primer.data"
  ) +
  theme_minimal() +
  theme(axis.text.y  = element_blank(),
        axis.ticks.y = element_blank())
