...
#| echo: false
learnr2::question(
  "Paste a screenshot showing that you are signed in to your new GitHub account -- for example, your GitHub profile page, or the account menu in the upper right corner of github.com.",
  type = "reflection",
  allow_image = TRUE
)
```
...
```{r}
#| label: use-either-chrome-or-edge-1
#| echo: false
learnr2::question(
  "Paste a screenshot showing that you are using Chrome or Edge -- for example, the browser's \"About\" page (from its menu), which names the browser and its version.",
  type = "reflection",
  allow_image = TRUE
)
```
...
```{r}
#| label: launching-the-codespace-1
#| echo: false
learnr2::question(
  "Paste a screenshot of your own Codespace's ready message. It will look like the example above, but with your own randomly-assigned name instead of `fictional winner`.",
  type = "reflection",
  allow_image = TRUE
)
```
...
```{r}
#| label: touring-the-workspace-1
#| echo: false
learnr2::question(
  "Paste a screenshot of the plot you created with `plot(1:10)`.",
  type = "reflection",
  allow_image = TRUE
)
```
...
```{r}
#| label: stopping-restarting-and-deleting-the-codespace-1
#| echo: false
learnr2::question(
  "Paste a screenshot of your Codespaces control panel (https://github.com/codespaces) showing this Codespace stopped, or already deleted.",
  type = "reflection",
  allow_image = TRUE
)
```
