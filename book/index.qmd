...
The *Primer* is being re-written. Consider it all to be a  draft, at least for now. There are three major changes in progress. First, I am switching from **brms** to **tidymodels** and **marginaleffects**. Second, I am standardizing the usage of the Cardinal Virtues. Third, I am using Claude to help with both writing and coding.
