...
When you are done with the tutorial, **stop** the Codespace — same way as before, via the Command Palette or your [Codespaces page](https://github.com/codespaces). You should then delete the Codespace. (Strictly speaking, you can delete the Codespace without stopping it first.)

### Using your own machine

You can do all of this work on your own laptop, if you prefer. But, in that case, you are responsible for setting everything up. That means installing VS Code, Git and R. You will also need to install, by hand, various R packages. From the R Terminal, you would run commands like:
...
That should be enough to get you started, If you have trouble, ask AI, pointing it toward this chapter and to the `PPBDS/codespace-starter` repo.
