...
After clicking the green "Create repository" button, your screen should look like the one below. Click the green "Code" button. It shows two options: "Local" and "Codespaces." Use "Local" if you want to work on your own machine. Select "Codespaces" to work in the cloud.
