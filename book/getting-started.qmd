...
This section has two purposes: first, introduce you to GitHub Codespaces and VS Code and, second, help you complete the Getting Started tutorial.
...
### Creating a Codespace  {.unnumbered}

Instead of working on your computer, you will work in a [GitHub Codespace](https://github.com/features/Codespaces). This is a cloud-based [virtual machine](https://en.wikipedia.org/wiki/Virtual_machine), that we can much more easily set-up for doing data science, instead of manually setting up for this work on your computer.
...
Second, type `Cmd + Shift + P` (on Mac) or `Ctrl + Shift + P` (on Windows/Linux) to bring up the Command Palette. (Throughout this book, shortcuts are written like `Cmd/Ctrl + Shift + P`, meaning the `command` key on Mac or the `control` key on Windows/Linux.) The Command Palette provides access to all VS Code commands. Type `stop` into the search bar.s

On some browsers, the keyboard shortcut does not work. You can always access the Command Palette by clicking the search bar at the top of the window and type `>` followed by the command you would like to use.
...
Go ahead and stop your Codespace using one of the methods above.

Now let's re-open a Codespace that you just stopped. Go to `https://github.com/Codespaces`. You can also navigate to this page on from your GitHub homepage by selecting the three horizontal bar icon in the top right and then selecting "Codespaces" from the sidebar menu.
...
From this page, click on the title of the Codespace you'd like to open. This will open a new tab with your Codespace.
