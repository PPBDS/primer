...
You can stop a codespace by hand by clicking on the blue codespace button in the lower lefthand corner, thereby bring up a variety of possible commads. Type "stop" in the search bar and one of the options will be "Stop Current Codespace." Select it.
```{r}
knitr::include_graphics("getting-started/images/stopCodespace.png")
```
