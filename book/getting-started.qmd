...
There are three common approaches to closely codespaces.

First, just leave the codespace along and it will close on its own. GitHub monitors codespaces. By default, it will close your codespace if it is not being used for 30 minutes, although I recommend changing that default to 15 minutes.
