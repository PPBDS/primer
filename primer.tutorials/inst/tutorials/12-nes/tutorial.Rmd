...
Create a Github repo called `nes`. Make sure to click the "Add a README file" check box.
...
Select `File -> New File -> Quarto Document ...`. Provide a title -- `"NES"` -- and an author (you). Render the document and save it as `analysis.qmd`.
...
We need `fit_nes` to exist in R World. Copy/paste this code into the Console and execute it.
