...
Create a Github repo called `biden`. Make sure to click the "Add a README file" check box.
...
Select `File -> New File -> Quarto Document ...`. Provide a title -- `"Biden"` -- and an author (you). Render the document and save it as `analysis.qmd`.
