...
Create a Github repo called `colleges`. Make sure to click the "Add a README file" check box.
...
Select `File -> New File -> Quarto Document ...`. Provide a title -- `"Colleges"` -- and an author (you). Render the document and save it as `ordered.qmd`.
...
We need `fit_colleges` to exit in R World. Copy/paste this code into the Console and execute it.
