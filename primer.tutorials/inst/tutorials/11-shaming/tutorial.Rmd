...
Create a Github repo called `shaming`. Make sure to click the "Add a README file" check box.
...
Select `File -> New File -> Quarto Document ...`. Provide a title -- `"Shaming"` -- and an author (you). Render the document and save it as `postcards.qmd`.
...
We need `fit_vote` to exist in R World. Copy/paste this code into the Console and execute it.
