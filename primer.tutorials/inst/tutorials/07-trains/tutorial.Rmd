...
population_tibble <- tibble::tribble(
  ...
  "..."      , "..."            , "..."  , "..."                 , "..."                     , "..."              ,
  "Preceptor", "James Carter"   , "2026" , "10"                  , "8"                       , "Exposed"          ,
  "Preceptor", "Maria Gonzalez" , "2026" , "9"                   , "7"                       , "Not exposed"      ,
  "Preceptor", "..."            , "..."  , "..."                 , "..."                     , "..."              ,
  "Preceptor", "Robert Kim"     , "2026" , "11"                  , "9"                       , "Exposed"          ,
  "..."      , "..."            , "..."  , "..."                 , "..."                     , "..."
)

pop_title_footnote     <- "This table combines data from Enos (2014) with the Preceptor Table's 2026 Georgia voters, both drawn from the population of US adults who might encounter Spanish speakers in public settings."
pop_units_footnote     <- "Data rows are participants in Enos's 2012 Boston MBTA commuter rail experiment — 115 commuters. Preceptor rows are registered voters in a Georgia congressional district in 2026."
pop_outcome_footnote   <- "Immigration attitude on a scale from 3 (most liberal) to 15 (most conservative). In Data rows, only one potential outcome was observed — the one matching the subject's treatment; the other is shown as '...' because it was never measured. In Preceptor rows, both potential outcomes are filled in (the unobservable one is cross-hatched), because Preceptor rows show the unobservable truth."
pop_treatment_footnote <- "In Data rows, Spanish Exposure is whether the Boston commuter rode alongside Spanish-speaking confederates during Enos's experiment. In Preceptor rows, it is whether the Georgia voter was exposed to Spanish-speaking campaign volunteers."
pop_effect_footnote    <- "The causal effect for Maria Gonzalez is the difference between her two potential outcomes: 9 − 7 = 2 points on the 3–15 scale. Because the Preceptor rows show the unobservable truth, this is the true causal effect for her, not an estimate."
