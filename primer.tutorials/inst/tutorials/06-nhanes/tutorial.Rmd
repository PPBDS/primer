...
Create a Github repo called `nhanes`. Make sure to click the "Add a README file" check box.
...
Select `File -> New File -> Quarto Document ...`. Provide a title -- `"NHANES"` -- and an author (you). Render the document and save it as `analysis.qmd`.
...
We will work from the National Health and Nutrition Examination Survey (NHANES), conducted by the Centers for Disease Control and Prevention, available in the `nhanes` tibble of the `primer.data` package.
