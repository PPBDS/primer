...
1. https://docs.astral.sh/uv/getting-started/installation/ at this link, go to the installation section in the appendix, and execute the specified code in Positrons terminal, based on the device you are using.
