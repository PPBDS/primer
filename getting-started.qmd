...
2. [Download and install Positron](https://positron.posit.co/download.html). If using a Mac, figure out if you should use the "arm64" or "x64" version. If your Mac is not too old, you want "arm64." Avoid the universal installer.
