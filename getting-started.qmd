...
You can also create your own codespace from scratch. But, since this all very new, we have created the basic setup files, mainly `devcontainer.json`, in a sensible fashion in this GitHub repositary. In particular, we ensure that R is installed along with some important packages and some useful extensions for VS Code.
...
The next screnshot shows that you are now on your GitHub account in the newly created repo, `my-repo`. 
...
This is Visual Studio Code--aka "VS Code" or even "VScode"--an integrated developement environment (IDE) for coding and data science. Highlights:
