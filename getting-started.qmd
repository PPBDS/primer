...
Instead of loading the **pak** package explicitly, we used the double colon notation --- `::` --- to refer directly to the `pak()` function which resides, somewhat confusingly, in the **pak** package.
