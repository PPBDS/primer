...
We provide two different computing approaches for doing data science: first, working in the cloud using GitHub Codespaces and, second, using your local machine.

## GitHub Codespaces

### GitHub

The first step in becoming a data scientist is to sign up for a GitHub account by following the instructions at the [GitHub homepage](https://github.com/). 

**Follow [this advice](https://happygitwithr.com/github-acct.html#username-advice) when choosing your username.** 

Use a permanent email address for this account, not one to which you lose access when, for example, you change schools or jobs.

### First codespace

Instead of working on your computer, you will work in a [GitHub codespace](https://github.com/features/codespaces).

Once you are logged on to your GitHub account, go to this URL in your browser:

https://github.com/PPBDS/codespace-starter

Click on the "Use this template" green rectangle in the upper right. Select the "Open in a codespace" option.

This will take a few minutes to run. Read the rest of this chapter while you are waiting. Behind the scenes, GitHub is creating a virtual machine in the cloud with all the necessary tools for doing data science. That machine is called a "codespace." GitHub allows for free usage of codespaces for 60 hours a month, and probably more if you join [GitHub education](https://github.com/education), which we highly recommend for students.
