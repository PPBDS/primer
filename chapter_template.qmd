...
<!-- IS: should we have an overview of the packages here, like in other tutorials? or should we just give background information on the data? -->

### Scenarios

<!-- IS: do we simply introduce them (like the section in the classwork recently) or explain them a little more? -->
...
<!-- IS: explore each of the concepts for each scenario? -->
