...
- **Preceptor's Question for Class (required).** In the Wisdom section, include a subsection titled "Question for Class This Week." **State one focused predictive or causal question targeting next year's outcomes directly (e.g., "What will be the average height of male and female USMC recruits next year?") instead of analyzing current sample differences.** This question anchors the class's week of work.
- **End-of-exercise summary.** Temperance should ask students to state the modeling strategy, the quantity of interest, and the main remaining uncertainty in a short paragraph. This reinforces that the final answers are predictive and that uncertainty is part of the conclusion.
