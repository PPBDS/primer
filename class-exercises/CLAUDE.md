...
- **Final-product workflow.** When a class exercise ends with a publishable artifact, the final section should guide students to create a short Quarto document, include at least one plot, and publish it to GitHub Pages. The instructor answer key should show the completed version of that deliverable.
