...
- **Student handout philosophy.** The student file should function like a guided worksheet: short prompts, reasoning questions, discussion starters, and a few light data-exploration tasks. It should not spend students' time copying code, debugging, or formatting tables. The instructor file should contain the missing code, completed written answers, completed tables, rendered figures, and only the comments that add pedagogical value.
